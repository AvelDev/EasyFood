...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      description: "Każdy w zespole może zagłosować na swoją ulubioną restaurację",
    ...
    },
    {
      ...
      description: "Zobacz wyniki głosowania i status zamówień w czasie rzeczywistym",
    ...
    },
    {
      ...
      description: "Twoje dane są chronione i dostępne tylko dla członków zespołu",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Każdy członek zespołu wybiera swoją preferowaną restaurację"
    },
    {
      number: "3",
      title: "Wyniki są podliczane",
      description: "Automatyczne podsumowanie głosów i wybór zwycięskiej restauracji"
    },
    {
      number: "4",
      title: "Składanie zamówień",
      description: "Członkowie zespołu dodają swoje zamówienia z wybranej restauracji"
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 sm:py-24">
          ...
          >
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
              Uprość proces zamawiania jedzenia w swojej firmie. Głosujcie razem na restauracje, 
              składajcie zamówienia i cieszczcie się wspólnymi posiłkami.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Odkryj funkcje, które czynią zamawianie jedzenia w zespole prostym i przyjemnym
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className={`bg-gradient-to-br ${feature.gradient} ${feature.border} h-full hover:shadow-lg transition-all duration-300 hover:scale-105`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-8">
                EasyFood rozwiązuje typowe problemy związane z zamawianiem jedzenia w zespole
              </p>
              ...
              <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl p-8">
                <div className="bg-white rounded-xl p-6 shadow-lg">
                  ...
                  <p className="text-slate-600 mb-4">
                    Zespoły używające EasyFood oszczędzają średnio 15 minut dziennie 
                    na organizację zamawiania jedzenia.
                  </p>
